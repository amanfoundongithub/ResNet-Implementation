...
# from dhdhd import ResNet, ResidualBlock
from ResNet34.ResNet34 import ResNet
from MoodDataLoader import MoodDataLoader
...
class MoodClassifier:
    ...
    def train(self, num_epochs = 20):
        ...
        MoodData = MoodDataLoader(
            batch_size = 40
        )

        # Load the training dataset from the loader 
        train_loader, length = MoodData.load_train_dataset()

        test_loader, length_of_test = MoodData.load_test_dataset() 
        ...
        for epoch in range(num_epochs):
            ...
            self.test_accuracy(test_loader, length_of_test)
            print("\n-------------")
    

    def test_accuracy(self, test_loader, length_of_test):
